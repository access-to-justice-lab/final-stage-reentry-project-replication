...
***********************************
import delimited using "./incomeRDataAdmin.csv", clear  // 


*********************
*** Main IV Model ***
*********************
ivreg2 income_ratio (i.expunge i.expunge#c.seq = i.treatment i.treatment#c.seq) ///
...
preserve
	...
	gen double outcome_hat = pe_income_avg * xb_trans
	gen double outcome_hat_ll = pe_income_avg * xb_ll_trans
	gen double outcome_hat_ul = pe_income_avg * xb_ul_trans
	
	keep stid seq treatment expunge income_ratio pe_income_avg outcome_hat outcome_hat_ll outcome_hat_ul

	export delimited using "./incomeRAdmin_predictions.csv", replace
...
export delimited using "./incomeRAdmin_Meffects.csv", replace
...
export delimited using "./incomeRAdminTE.csv", replace

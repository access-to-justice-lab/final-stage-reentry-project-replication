...
forvalues filenum = 1/`imputations' {
	...
	*****************************
	*** Main LPM IV OLS Model ***
	*****************************
	ivreg2 full_time (i.expunge i.expunge#seq = i.treatment i.treatment#seq) ///
	white age_enroll female income_lag ps_income full_time_lag local_unemploy ps_employed married dependent i.seq i.year, ///
		cluster(stid)
	...
	* Time-varying LATEs
	...
	export delimited effect b se pvalue ll ul using "./full_time_treatment_effectsLPM`filenum'.csv", replace
	...
	****************************************************
	...
	export delimited Expungement Sequence b se pvalue ll ul using "./full_time_group_probsLPM`filenum'.csv", replace
	...
	***************************************************
	...
	export delimited using "./full_time_MELPM`filenum'.csv", replace

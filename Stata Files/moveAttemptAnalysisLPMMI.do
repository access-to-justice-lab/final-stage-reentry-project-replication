...
forvalues filenum = 1/`imputations' {
	...
	*** Main LPM Model ***
	**********************
	ivreg2 move_attempt (i.expunge i.expunge#seq = i.treatment i.treatment#seq) ///
	white female age_enroll income_lag house_num house_size unemploy_lag local_unemploy ps_income ps_employed ps_move_attempt married dependent i.seq i.year, ///
		cluster(stid)
	...
	* Time-varying LATEs
	...
	export delimited effect b se pvalue ll ul using "./moveAttempt_treatment_effectsLPM`filenum'.csv", replace
	...
	****************************************************
	...
	export delimited Expungement Sequence b se pvalue ll ul using "./moveAttempt_group_probsLPM`filenum'.csv", replace
	...
	***************************************************
	...
	export delimited using "./moveAttempt_MELPM`filenum'.csv", replace
